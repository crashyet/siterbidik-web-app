  ...
  return (
    <section className='relative w-full min-h-screen bg-white py-6 px-8'>
      ...
      <div className="flex items-center gap-4 mb-8 mt-5">
        ...
        <h1 className="absolute left-1/2 -translate-x-1/2 text-lg font-bold text-center text-purple-main font-Montserrat">Tes Keterampilan<br/>Bicara</h1>
      </div>
      ...
      <div className="space-y-4">
        {exams.map((exam) => (
          <div 
            key={exam.id}
            onClick={() => navigate(`/bicara-exam/${exam.id}`)}
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <h3 className="font-medium text-gray-900 text-sm mb-1">{exam.title}</h3>
