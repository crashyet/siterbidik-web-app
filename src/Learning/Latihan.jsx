...
const Latihan = () => {
  ...
  return (
    <section className="relative bg-purple-main min-h-screen">
      <div className="top-0 px-3 z-50 pt-15 pb-6">
        <div className="flex px-3.5 items-center relative">
          ...
          {/* Title tengah */}
          <h1 className="absolute left-1/2 -translate-x-1/2 font-Montserrat font-bold text-xl text-white">
            Latihan
          </h1>
        </div>

        <div className="bg-white p-4 rounded-4xl mt-10">
          <div className="bg-light-purple px-2 py-3.5 rounded-2xl shadow-md mb-5">
            <div className="px-0.5 mb-2">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-2 mr-1">
                  ...
                  <h1 className='font-Montserrat font-bold text-[#A9A9A9] text-xs'>10/40 Soal</h1>
                </div>
              </div>
          ...
          <div className="bg-light-purple px-4 rounded-2xl shadow-md pt-3 pb-5.5">
            <div className="grid grid-cols-2 gap-5">
              <div className="bg-white rounded-2xl p-2 flex flex-col gap-2 items-center">
                ...
                <div className="flex flex-col items-center gap-1">
                  ...
                  <p className='font-Montserrat font-normal text-[#A9A9A9] text-xs'>10 Soal</p>
                </div>
                <button onClick={() => navigate('/quiz/1')} className="bg-purple-main text-white font-Montserrat font-bold text-xs rounded-xl w-full py-2">Mulai</button>
              </div>
              ...
              <div className="bg-white rounded-2xl p-2 flex flex-col gap-2 items-center">
                ...
                <button onClick={() => navigate('/quiz/2')} className="bg-purple-main text-white font-Montserrat font-bold text-xs rounded-xl w-full py-2">Mulai</button>
              </div>
              ...
              <div className="bg-white rounded-2xl p-2 flex flex-col gap-2 items-center">
                ...
                <button onClick={() => navigate('/quiz/3')} className="bg-purple-main text-white font-Montserrat font-bold text-xs rounded-xl w-full py-2">Mulai</button>
              </div>
              ...
              <div className="bg-white rounded-2xl p-2 flex flex-col gap-2 items-center">
                ...
                <button onClick={() => navigate('/quiz/4')} className="bg-purple-main text-white font-Montserrat font-bold text-xs rounded-xl w-full py-2">Mulai</button>
              </div>
            </div>
          </div>
        </div>
